...
declare type EventSubscription<EM : events$EventEmitter<*, *>, E : string, F : Function> = (event : E, cb : F) => EM;

declare class events$EventEmitter<E : string, T : EventSubscription<*, *, *>> {
  // deprecated
  static listenerCount(emitter: events$EventEmitter<*, *>, event: string): number;

  addListener: T;
  emit(event: E, ...args:Array<any>): boolean;
  listeners(event : E) : Array<Function>;
  listenerCount(event: E): number;
  on: T;
  once: T;
  removeAllListeners(event?: E): events$EventEmitter<E, T>;
  //you could save somewhere your typed function as variable of Function type.
  removeListener(event: E, listener: Function): events$EventEmitter<E, T>;
